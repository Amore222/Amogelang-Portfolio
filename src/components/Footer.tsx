    ...
    <footer className="relative overflow-hidden border-t border-primary/20 bg-card/30 backdrop-blur-sm">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 font-mono translate-x-[-40px] md:translate-x-[-60px]"
          >
      ...
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-20 sm:bottom-24 md:bottom-28 right-8 z-50 w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-cyan-500 flex items-center justify-center text-white shadow-lg hover:shadow-purple-500/50 transition-shadow group"
        >
          <motion.div
            animate={{ y: [-2, 2, -2] }}
            transition={{ duration: 1.5, repeat: Infinity }}
